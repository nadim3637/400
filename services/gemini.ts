...
export const fetchLessonContent = async (
  ...
  if (template) {
      ...
      Hindi Section Structure:
      Translate the above structure and content into Hindi (Devanagari script). Ensure technical terms are explained clearly.
